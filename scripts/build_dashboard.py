...
def block2_statuses(audit, site_unavailable):
    ...
    digital_tool_status = "проблема" if service_pages_count <= 4 else "ок"
...
def metric_tooltip(block_id: str, metric_idx: int, metric_name: str) -> str:
    block2 = {
        ...
        1: "Оценка: 'ок' — страниц услуг >=5; 'проблема' — страниц услуг <=4.",
...
<body>
  ...
  <div class=\"method-template\" id=\"methodology-b2\">
    ...
    <p><b>ок:</b> страниц услуг &gt;= 5. <b>проблема:</b> страниц услуг &lt;= 4.</p>
